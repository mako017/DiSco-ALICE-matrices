...
function drawBox(el, pos = 0, col = '#000000') {
    let ctx = el.getContext("2d");
    let corners = [[10,10],[10,90],[90,90],[90,10]];
...
function drawShape(el, shape=0, fill=false, col = '#000000') {
    ...
    switch (shape) {
        case 0:
            ...
            break;
        case 1:
            ctx.arc(elInfo.width/2, elInfo.height/2, elInfo.width/10, 0, 2 * Math.PI);
            break;
